            ...
            <div className={styles.aboutContent}>
                ...
                <div className={styles.aboutText}>
                    ...
                    <div className={styles.aboutInfo}>
                        <div><span>1.5+</span><p>ANOS DE EXP.</p></div>
                        <div><span>5</span><p>PROJETOS ENTREGUES</p></div>
                        <div><span>1</span><p>CLIENTE FELIZ</p></div>
                        <div><span>∞</span><p>TÉRES TOMADOS</p></div>
                    </div>
                </div>
